                        ...
                        <div class="box-body">
                            ...
                            <div class="col-xs-6">
                                <div class="btn-group pull-right">
                                    <button class="btn btn-default btn-flat"><i class="fa fa-refresh"></i> 刷新</button>
                                    <button class="btn btn-default btn-flat"><i class="fa fa-plus"></i> 新增</button>
                                    <button class="btn btn-default btn-flat"><i class="fa fa-edit"></i> 编辑</button>
                                    <button class="btn btn-default btn-flat"><i class="fa fa-trash-o"></i> 删除</button>
                                    <button class="btn btn-default btn-flat"><i class="fa fa-list-alt"></i> 详细</button>
                                </div>
                            </div>
